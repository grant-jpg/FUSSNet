...
res_dir = 'result/pancreas_VNet_{}_seed/'.format(al_weight)
...
def train(net, ema_net, optimizer, lab_loader, unlab_loader, test_loader):
    save_path = Path(res_dir) / 'panc_al_weight_{}'.format(al_weight)
    save_path.mkdir(exist_ok=True)
    ...
    pretrained_path = Path('/home/xiangjinyi/semi_supervised/MLNet/result/pancreas_VNet_8_cora/pretrain_con_5.0')
