...
data_root = '../pancreas/Pancreas-processed'
...
def get_model_and_dataloader():
    ...
    trainset_lab = Pancreas(data_root, dataset_name, split='train_lab', require_mask=True)
    ...
    testset = Pancreas(data_root, dataset_name, split='test')
...
def test(net, val_loader, maxdice=0, save_result=False, test_save_path='./save'):
    metrics = test_calculate_metric(net, val_loader.dataset, save_result=save_result, test_save_path=test_save_path)
    val_dice = metrics[0]
...
if __name__ == '__main__':
    ...
    model_path = Path('/home/xiangjinyi/semi_supervised/alnet/result/single_loss_ce_12/pretrain_con_5.0')

    load_net_opt(net, optimizer, model_path / '55.pth')
