...
def test_calculate_metric(net, test_dataset, num_classes=2, save_result=False, test_save_path='./save'):
    net.eval()
...
def test_calculate_metric_LA(net, test_dataset, num_classes=2, save_result=False, test_save_path='./save'):
    net.eval()
